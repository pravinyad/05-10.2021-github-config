...
public class TC_26_1ContactsPortalUserBoxEnabled extends BaseClass {
	
	
	@Test(groups={"SmokeSuite"})
    public void ContactsWithPortalUserBoxEnabled() throws Throwable, Throwable{
		...
		// click on "Contacts link" from HomePage POM
				...
				// tick the "portal user" checkbox
				cnc.clickOnportalUserCheckBox();
				...
				//Assert.assertEquals(false, true); To use Listner feature this is intentionally aadded
