...
public class TC_27_2ContactsWithEmailOptOutBoxEnabled extends BaseClass{
	
	
	
	@Test(groups={"SmokeSuite"})
	public void ContactsWithEmailOptOutBox() throws Throwable, Throwable {
		...
		// click on "Contacts link" from HomePage POM
				...
				// tick the "email opt out" checkbox
				cnc.clickOnemailOptOutCheckBox();
