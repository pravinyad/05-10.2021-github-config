...
public class TC_30_4ContactsWithNotifyOwnerCheckboxEnabled extends BaseClass{
	@Test(groups={"RegSuite"})
	public void ContactsWithNotifyOwnerCheckboxEnabled() throws Throwable, Throwable {
		// Test case data
				...
				// click on "Contacts link" from HomePage POM
						...
						// tick the "notify owner" checkbox
						cnc.clickOnnotifyOwnerCheckBox();
